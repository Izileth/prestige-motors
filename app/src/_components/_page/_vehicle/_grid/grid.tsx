...
import {  ArrowRight, ChevronLeft, ChevronRight,  SunIcon, Trophy, Truck, Zap, Car, RocketIcon, Rocket, Bike, Flame, Key, Mountain, Disc, Eye, Factory, Wrench, Clock, Flashlight, Settings} from "lucide-react"
...
const categories = [
    ...
    },
    {
        ...
        icon: <Trophy size={24} />,
        description: 'Carros de alto desempenho projetados para velocidade extrema.',
    },
    {
        id: 'DRIFT_CAR',
        name: 'Drift Machines',
...
export const CategoryGrid = () => {
    ...
    const handleTouchMove = (e: React.TouchEvent) => {
        ...
        const basePosition = activeIndex * (carouselRef.current.scrollWidth / categories.length)
